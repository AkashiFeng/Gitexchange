    ...
    <div class="register-container">
        <div class="container">
            <div class="register-card">
                ...
                <input type="submit" name="submit" value="<?= Lang::string('login-forgot-send-new') ?>" class="btn btn-primary" />
                <!-- <a href="login.html" class="btn btn-primary">Reset</a> -->
                <p class="note"><span>Don't have an account? <a href="register">Register</a></span></p>
            </div>
