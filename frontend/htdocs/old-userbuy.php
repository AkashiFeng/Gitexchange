    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul>
            ...
            <li>If you want to use a Litecoin (LTC) to buy Bitcoin (BTC), use LTC/BTC</li>
            <li>Once you choose the respective currency pair, it will reflect in the Buy or Sell Box.</li>
